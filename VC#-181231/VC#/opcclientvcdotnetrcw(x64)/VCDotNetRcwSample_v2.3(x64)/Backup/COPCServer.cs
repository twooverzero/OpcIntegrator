...
namespace VCDotNetRcwSample
{
	...
	// ShutDownEventHandler関数を宣言
	public delegate void ShutDownRequestHandler(string sReadson);
	// 2011/11/14 シャットダウンイベントを受けれるようにする	)

 //	public class COPCServer : IOPCDataCallback				    // 2011/11/14 シャットダウンイベントを受けれるようにする
	public class COPCServer : IOPCDataCallback, IOPCShutdown	// 2011/11/14 シャットダウンイベントを受けれるようにする

	{
		...
		public event ShutDownRequestHandler ShutDownRequestEvent;		// 2011/11/14 シャットダウンイベントを受けれるようにする
