...
*/
		...
		private static readonly string STR_OPC_INI		= "VCDotNetRcwSample.ini";

		private static readonly int VAL_CTRL_SPACE = 8;
		...
		private static readonly int VAL_ITEMNAME_WIDTH = 120;
		private static readonly int VAL_VALUE_HEIGHT = VAL_ITEMNAME_HEIGHT;
		private static readonly int VAL_VALUE_WIDTH = 80;
		private static readonly int VAL_TIME_HEIGHT = VAL_ITEMNAME_HEIGHT;
		private static readonly int VAL_TIME_WIDTH = 130;
		...
		public Form1()
		{
            ...
            OPCSvr.ShutDownRequestEvent += new ShutDownRequestHandler(OPCSvr_ShutDown);	// 2011/11/14 シャットダウンイベントを受けれるようにする
		...
		private System.Windows.Forms.RadioButton rdoDA30;
		private System.Windows.Forms.RadioButton rdoDA20;
		...
		private void InitializeComponent()
		{
			...
			this.txtUpdateRate.Location = new System.Drawing.Point(95, 87);
			...
			this.rdoDA30.Location = new System.Drawing.Point(363, 64);
			this.rdoDA30.Name = "rdoDA30";
			this.rdoDA30.Size = new System.Drawing.Size(48, 16);
			...
			this.rdoDA20.Location = new System.Drawing.Point(307, 64);
			this.rdoDA20.Name = "rdoDA20";
			this.rdoDA20.Size = new System.Drawing.Size(48, 16);
			...
			this.btnAsyncWrite.Location = new System.Drawing.Point(307, 163);
			this.btnAsyncWrite.Name = "btnAsyncWrite";
			this.btnAsyncWrite.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.btnAsyncWrite.Size = new System.Drawing.Size(104, 32);
			...
			this.btnAsyncRead.Location = new System.Drawing.Point(196, 163);
			this.btnAsyncRead.Name = "btnAsyncRead";
			this.btnAsyncRead.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.btnAsyncRead.Size = new System.Drawing.Size(104, 32);
			...
			this.btnMaxAge.Location = new System.Drawing.Point(81, 125);
			this.btnMaxAge.Name = "btnMaxAge";
			this.btnMaxAge.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.btnMaxAge.Size = new System.Drawing.Size(104, 32);
			...
			this.btnAdvise.Location = new System.Drawing.Point(81, 163);
			this.btnAdvise.Name = "btnAdvise";
			this.btnAdvise.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.btnAdvise.Size = new System.Drawing.Size(104, 32);
			...
			this.btnWrite.Location = new System.Drawing.Point(307, 125);
			this.btnWrite.Name = "btnWrite";
			this.btnWrite.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.btnWrite.Size = new System.Drawing.Size(104, 32);
			...
			this.btnRead.Location = new System.Drawing.Point(196, 125);
			...
			this.btnConnect.Location = new System.Drawing.Point(307, 87);
			...
			this.Label4.Location = new System.Drawing.Point(371, 206);
			...
			this.Label3.Location = new System.Drawing.Point(273, 206);
			...
			this.txtNode.Location = new System.Drawing.Point(95, 12);
			this.txtNode.Name = "txtNode";
			this.txtNode.Size = new System.Drawing.Size(133, 20);
			...
			this.cmbSvrName.Location = new System.Drawing.Point(95, 38);
			this.cmbSvrName.Name = "cmbSvrName";
			this.cmbSvrName.Size = new System.Drawing.Size(133, 20);
			...
			this.btnRefresh.Location = new System.Drawing.Point(238, 12);
			...
			this.txtGrp.Location = new System.Drawing.Point(95, 62);
			this.txtGrp.Name = "txtGrp";
			this.txtGrp.Size = new System.Drawing.Size(90, 20);
			...
			this.label10.Location = new System.Drawing.Point(272, 556);
			...
			this.chkGrpActive.Location = new System.Drawing.Point(330, 42);
			this.chkGrpActive.Name = "chkGrpActive";
			this.chkGrpActive.Size = new System.Drawing.Size(87, 16);
...
//						if (wQuality[i] != 0)
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			spFolder = System.Environment.GetFolderPath(Environment.SpecialFolder.Personal) +"\\TAKEBISHI\\DeviceXPlorer OPC Server\\Sample";
			csInifilePath = spFolder + "\\" + STR_OPC_INI;
			...
			if ( bErr == true )
			{
				...
				cmbSvrName.Text = "Takebishi.Dxp.1";	// 07/06/23 for DXP2007
				txtGrp.Text = "Group1";
		...
		protected override void OnClosed(EventArgs e)
		{
			...
			if (OPCSvr != null) 
			{
				...
				try 
				{
					...
					using (StreamWriter sw = new StreamWriter(csInifilePath)) 
					{
		...
		private void btnConnect_Click(object sender, System.EventArgs e)
		{
			...
			{
				// --- connect OPCServer
				if (OPCSvr.Connect(OpcdaVer, txtNode.Text, cmbSvrName.Text, txtGrp.Text, int.Parse(txtUpdateRate.Text)) == true)
				{
					for (i = 0; i < ITEMMAX; i++) 
					{
